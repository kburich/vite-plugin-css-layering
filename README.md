# CSS Layering Plugin for Vite &middot; [![RL Status Badge](https://secure.software/npm/badge/vite-plugin-css-layering)](https://secure.software/npm/packages/vite-plugin-css-layering)
